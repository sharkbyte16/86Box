...
set_screen_size_monitor(int x, int y, int monitor_index)
{
    ...
    switch (scale) {
        case 0: /* 125% */
            monitors[monitor_index].mon_scrnsz_x = ((monitors[monitor_index].mon_unscaled_size_x * 5) >> 2);
            monitors[monitor_index].mon_scrnsz_y = ((monitors[monitor_index].mon_unscaled_size_y * 5) >> 2);
            break;
