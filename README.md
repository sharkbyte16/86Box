...
About this fork
---------------
* Added icons for a large selection of historic computer brand logos and a few actual machine pictures.
* Changed the 0.5x Window scale factor to 1.25x to better match the size ancient 13" monitors on a current 24" display.
